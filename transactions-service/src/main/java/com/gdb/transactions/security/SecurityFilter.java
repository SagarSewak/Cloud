...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            // Fixed MOD8-CR-01: Token revocation validation blacklist check.
            if (validationResponse.isValid() && !validationResponse.isRevoked()) {
                ...
                log.warn("Invalid or revoked token for path: {}", path);
                response.sendError(HttpServletResponse.SC_UNAUTHORIZED, 
                        validationResponse.isRevoked() ? "Token has been revoked" : "Invalid or expired token");
                return;
            }
        } else {
